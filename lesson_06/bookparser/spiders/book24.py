...
# //a[@class='book__title-link js-item-element ddl_product_link ']

# //h1[@class='item-detail__title']
# //span[@class='rating__rate-value']

# //div[@class='item-actions__prices']
# //div[@class='item-actions__price']
# //div[@class='item-actions__price-old']
